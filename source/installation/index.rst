...
Dans un premier temps, vous allez `télécharger Galette <http://download.tuxfamily.org/galette/galette-0.7.2.6.tar.bz2>`_ et décompresser l'archive. Si vous êtes sous Linux, ça donnera quelque chose comme :

.. code-block:: bash

   $ cd /var/www/html/
   $ wget http://download.tuxfamily.org/galette/galette-0.7.2.6.tar.bz2
   $ tar xjvf galette-0.7.2.6.tar.bz2
