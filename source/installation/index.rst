...
.. image:: https://img.shields.io/badge/0.9.5.2-Galette-ffb619.svg?logo=php&logoColor=white&style=for-the-badge
   :target: https://download.tuxfamily.org/galette/galette-0.9.5.2.tar.bz2
...
::
   ...
   $ cd /var/www/html/
   $ wget https://download.tuxfamily.org/galette/galette-0.9.5.2.tar.bz2
   $ tar xjvf galette-0.9.5.1.tar.bz2
