...
.. image:: https://img.shields.io/badge/0.9.6.1-Galette-ffb619.svg?logo=php&logoColor=white&style=for-the-badge
   :target: https://download.tuxfamily.org/galette/galette-0.9.6.1.tar.bz2
...
The current stable version of Galette is |stable_version|. A `nightly archive <https://download.tuxfamily.org/galette/galette-dev.tar.bz2>`_ is build each night from the development branch, and you can also :doc:`retrieve Galette development version  <../source_code>` as explained in the developer guide.
