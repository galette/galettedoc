...
.. image:: https://img.shields.io/badge/1.1.1-Galette-ffb619.svg?logo=php&logoColor=white&style=for-the-badge
   :target: https://galette.eu/download/galette-1.1.1.tar.bz2
...
::
   ...
   $ cd /var/www/html/
   $ wget https://galette.eu/download/galette-1.1.1.tar.bz2
   $ tar xjvf galette-1.1.1.tar.bz2
