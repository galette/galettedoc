...
Chaque plugin est en fait un simple dossier qui doit être placé dans le dossier ``{galette}/plugins/``. La présence de certains fichiers dans le plugin permettent à Galette de savoir que faire :
